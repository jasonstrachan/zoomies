...
is a lightweight, native Windows magnifier application designed to provide screen magnification functionality without the bloat of traditional accessibility tools. The application offers real-time screen magnification controlled via keyboard shortcuts and mouse scroll.
